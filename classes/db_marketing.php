...
//require_once FILE_DB_MARKETING_TELEFOONTYPE;
require_once FILE_DB_MARKETING_TELEFOONLIJST;
...
/*the private functions are defined for db_marketing.php and marketing.php */
    private $klant_id;
    private $voornaam;
    private $achternaam;
    private $postcode;
 ...
 public function DbMarketing ($klant_id=''){
        ...
        if (empty($klant_id)){
            ...
            if( !$this->dbTableExists(TBL_MARKETING_EMAIL)){
                ...
                $msg_type = new DbMarketing_email();
                unset( $msg_type );                         
            }
